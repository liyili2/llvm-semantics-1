...
"\<lbrakk>tCFG_sim (add_reach CFGs' CFGs t sim_rel G' G) (op =) G' G (one_step t) obs (get_mem o snd); 
 ...
 tCFG_sim (lift_reach_sim_rel sim_rel CFGs' CFGs t) (op =) CFGs' CFGs conc_step obs (get_mem o snd)"
